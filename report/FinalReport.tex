...
\begin{document}
	...
	\begin{table}[htbp]
		...
		\begin{tabular}{@{}p{3.5cm}p{2.5cm}p{3.5cm}p{3cm}c@{}}
			...
			\midrule
			RTC Accuracy & DS1307 & Time deviation $< 1$ minute per month & \textit{One minute time difference} & Success \\
			Temperature Reading & LM35 & Reading within $0.5^\circ\text{C}$ of calibrated thermometer & \textit{Reading within 0.5◦C of calibrated thermometer} & Success \\
			Wireless Command Latency & HC-05 \& Arduino&  Message update latency $< 1$ second. & \textit{Message update latency > 4 second} & Success \\
			EEPROM Persistence & EEPROM & Retention of Mode/Message after 1 minute power-off & \textit{Retention of Mode/Message after 1 minute power-off} & Success \\
			Mode \& Effect Cycling & Arduino & Successful execution of all 5 Modes and 5 Scroll Effects & \textit{Successful execution of all 5 Modes and 5 Scroll Effects} & Success \\
			\bottomrule
		\end{tabular}
